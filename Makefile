...
COMMUNITY_CONTINUOUS_PROFILING_IMAGE ?= mattermost/community-continuous-profiling:test
...
.PHONY: build
build: ## Build the Community-Continuous_Profiling
	@echo Building Community-Continuous-Profiling
...
build-image:  ## Build the docker image for Community-Continuous_Profiling
	@echo Building Community-Continuous-Profiling Docker Image
	docker build \
	--build-arg DOCKER_BUILD_IMAGE=$(DOCKER_BUILD_IMAGE) \
	--build-arg DOCKER_BASE_IMAGE=$(DOCKER_BASE_IMAGE) \
	. -f build/Dockerfile -t $(COMMUNITY_CONTINUOUS_PROFILING_IMAGE) \
	--no-cache
